...
Route::resource('pdf-1', 'BoletaController');

Route::get('/ejemplo/llamada','EjemploController@llamada');
Route::get('/ejemplo/llamada_tres','EjemploController@llamada_tres');
Route::get('/ejemplo/boleta','EjemploController@boleta');
Route::get('/ejemplo/generarpdf','EjemploController@generarpdf');
Route::get('/ejemplo/generarpdf_h','EjemploController@generarpdf_h');


Route::post('/ejemplo/ejemplodos','EjemploController@ejemplodos');
